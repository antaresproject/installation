...
Antares Installer Module changelog can be found in release notes [antaresproject.io/docs/site/getting_started/changelog#installer](http://antaresproject.io/docs/site/getting_started/changelog/index.html#installer).
